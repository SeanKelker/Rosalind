...
public class TranslatingRNAintoProtein {
	...
	for (int i = 0; i < codons.length; i++) {
	    ...
	    } else if (codons[i].equals("UCU") || codons[i].equals("UCC") || codons[i].equals("UCA")
		    || codons[i].equals("UCG")) {
		finalsolution[i] = "S";
	    ...
	    } else if (codons[i].equals("CCU") || codons[i].equals("CCC") || codons[i].equals("CCA")
		    || codons[i].equals("CCG")) {
		finalsolution[i] = "P";
	    ...
	    } else if (codons[i].equals("CGU") || codons[i].equals("CGC") || codons[i].equals("CGA")
		    || codons[i].equals("CGG")) {
		finalsolution[i] = "R";

	    } else if (codons[i].equals("ACU") || codons[i].equals("ACC") || codons[i].equals("ACA")
		    || codons[i].equals("ACG")) {
		finalsolution[i] = "T";
	    ...
	    } else if (codons[i].equals("GUU") || codons[i].equals("GUC") || codons[i].equals("GUA")
		    || codons[i].equals("GUG")) {
		finalsolution[i] = "V";

	    } else if (codons[i].equals("GCU") || codons[i].equals("GCC") || codons[i].equals("GCA")
		    || codons[i].equals("GCG")) {
		finalsolution[i] = "A";

	    } else if (codons[i].equals("GGG") || codons[i].equals("GGA") || codons[i].equals("GGC")
		    || codons[i].equals("GGU")) {
		finalsolution[i] = "G";
